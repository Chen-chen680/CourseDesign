...
def get_msg():
    ...
    url = r'http://www.dianping.com/shop/G1Wk8Pk8LyS8IjIe/review_all'
    ...
    """
    dict_svg_text, list_svg_y, dict_css_x_y = css_get(html)
...
def css_get(doc):
    ...
    # css_link = 'http:' + doc('head > link:rel="stylesheet"')
    html = doc.content.decode('utf8')
    xpath_1 = "//head/link[@rel='stylesheet'][2]/@href"
    html = etree.HTML(doc.content.decode('utf8'))
    a = html.xpath(xpath_1)
    print(a)
    css_link = ''
